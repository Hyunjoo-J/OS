...
int main(void) {
   ...
   e:	51                   	push   %ecx
    int msize= memsize();
   f:	e8 6f 03 00 00       	call   383 <memsize>
    printf(1, "The process is using %dB\n", msize);
  14:	83 ec 04             	sub    $0x4,%esp
  17:	50                   	push   %eax
  18:	68 78 07 00 00       	push   $0x778
  1d:	6a 01                	push   $0x1
  1f:	e8 2c 04 00 00       	call   450 <printf>

    char *tmp = (char *)malloc(SIZE * sizeof(char));
  24:	c7 04 24 00 08 00 00 	movl   $0x800,(%esp)
  ...
  32:	58                   	pop    %eax
  33:	5a                   	pop    %edx
  34:	68 92 07 00 00       	push   $0x792
  39:	6a 01                	push   $0x1
  3b:	e8 10 04 00 00       	call   450 <printf>
    msize = memsize();
  40:	e8 3e 03 00 00       	call   383 <memsize>
    printf(1, "The process is using %dB\n", msize);
  ...
  5d:	59                   	pop    %ecx
  5e:	5b                   	pop    %ebx
  5f:	68 aa 07 00 00       	push   $0x7aa
  64:	6a 01                	push   $0x1
  66:	e8 e5 03 00 00       	call   450 <printf>
    msize = memsize();
  6b:	e8 13 03 00 00       	call   383 <memsize>
    printf(1, "The process is using %dB\n", msize);
  70:	83 c4 0c             	add    $0xc,%esp
  73:	50                   	push   %eax
  74:	68 78 07 00 00       	push   $0x778
  79:	6a 01                	push   $0x1
  7b:	e8 d0 03 00 00       	call   450 <printf>

    exit();
  80:	e8 5e 02 00 00       	call   2e3 <exit>
  85:	66 90                	xchg   %ax,%ax
  87:	66 90                	xchg   %ax,%ax
  89:	66 90                	xchg   %ax,%ax
  8b:	66 90                	xchg   %ax,%ax
 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 1c 08 00 00 	movzbl 0x81c(%edx),%edx
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 c4 07 00 00 	jmp    *0x7c4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba ba 07 00 00       	mov    $0x7ba,%edx
        while(*s != 0){
 ...
 5f1:	a1 c8 0a 00 00       	mov    0xac8,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 c8 0a 00 00    	mov    %edx,0xac8
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 c8 0a 00 00    	mov    %edx,0xac8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d c8 0a 00 00    	mov    0xac8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d c8 0a 00 00    	mov    0xac8,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 c8 0a 00 00    	mov    0xac8,%edx
 ...
 72c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 72f:	89 15 c8 0a 00 00    	mov    %edx,0xac8
}
 ...
 747:	0a 00 00 
    base.s.size = 0;
 74a:	bf cc 0a 00 00       	mov    $0xacc,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 cc 0a 00 00 cc 	movl   $0xacc,0xacc
 756:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 d0 0a 00 00 00 	movl   $0x0,0xad0
 762:	00 00 00 
    if(p->s.size >= nunits){
