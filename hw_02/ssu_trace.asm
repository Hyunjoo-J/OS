...
int main(int argc, char** argv){
  ...
  34:	e8 67 02 00 00       	call   2a0 <atoi>
  39:	89 04 24             	mov    %eax,(%esp)
  3c:	e8 7a 03 00 00       	call   3bb <trace>
  ...
  4d:	78 2d                	js     7c <main+0x7c>
		printf(1, "error : fork failed\n");
		exit();
	}
	if (pid == 0){
  4f:	75 1d                	jne    6e <main+0x6e>
  51:	eb 3c                	jmp    8f <main+0x8f>
  ...
  5a:	74 1b                	je     77 <main+0x77>
		printf(1, "zombie!\n");
  5c:	83 ec 08             	sub    $0x8,%esp
  5f:	68 00 08 00 00       	push   $0x800
  64:	6a 01                	push   $0x1
  66:	e8 15 04 00 00       	call   480 <printf>
  6b:	83 c4 10             	add    $0x10,%esp
	while ((wpid = wait()) >= 0 && wpid != pid){
  6e:	e8 a8 02 00 00       	call   31b <wait>
  73:	85 c0                	test   %eax,%eax
  75:	79 e1                	jns    58 <main+0x58>
	}
	exit();
  77:	e8 97 02 00 00       	call   313 <exit>
		printf(1, "error : fork failed\n");
  7c:	52                   	push   %edx
  7d:	52                   	push   %edx
  7e:	68 eb 07 00 00       	push   $0x7eb
  83:	6a 01                	push   $0x1
  ...
  8f:	50                   	push   %eax
  90:	50                   	push   %eax
  91:	8d 46 08             	lea    0x8(%esi),%eax
  94:	50                   	push   %eax
  95:	ff 76 08             	push   0x8(%esi)
  98:	e8 ae 02 00 00       	call   34b <exec>
		printf(1, "error : ssu_trace <%s> failed\n", argv[2]);
  9d:	83 c4 0c             	add    $0xc,%esp
  a0:	ff 76 08             	push   0x8(%esi)
  a3:	68 cc 07 00 00       	push   $0x7cc
  a8:	6a 01                	push   $0x1
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 68 08 00 00 	movzbl 0x868(%edx),%edx
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 10 08 00 00 	jmp    *0x810(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba 09 08 00 00       	mov    $0x809,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 18 0b 00 00       	mov    0xb18,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 18 0b 00 00    	mov    %edx,0xb18
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 18 0b 00 00    	mov    %edx,0xb18
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d 18 0b 00 00    	mov    0xb18,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d 18 0b 00 00    	mov    0xb18,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 18 0b 00 00    	mov    0xb18,%edx
 ...
 75c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 75f:	89 15 18 0b 00 00    	mov    %edx,0xb18
}
 ...
 76f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 18 0b 00 00 1c 	movl   $0xb1c,0xb18
 777:	0b 00 00 
    base.s.size = 0;
 77a:	bf 1c 0b 00 00       	mov    $0xb1c,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 1c 0b 00 00 1c 	movl   $0xb1c,0xb1c
 786:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 20 0b 00 00 00 	movl   $0x0,0xb20
 792:	00 00 00 
    if(p->s.size >= nunits){
