...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 1b 7c 10 80 	movl   $0x80107c1b,(%esp)
...
801024d2:	81 fb 30 56 11 80    	cmp    $0x80115630,%ebx
...
80103077:	68 30 56 11 80       	push   $0x80115630
...
801037d3:	81 fb b4 3d 11 80    	cmp    $0x80113db4,%ebx
...
801037f8:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037fb:	68 80 1d 11 80       	push   $0x80111d80
  p->pid = nextpid++;
...
80103828:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010382b:	c7 40 14 cf 58 10 80 	movl   $0x801058cf,0x14(%eax)
  p->context = (struct context*)sp;
...
8010383a:	e8 31 0e 00 00       	call   80104670 <memset>
...
8010384c:	89 d8                	mov    %ebx,%eax
  p->mask = 0;
8010384e:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
}
...
80103863:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103865:	68 80 1d 11 80       	push   $0x80111d80
...
80103893:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80103896:	68 80 1d 11 80       	push   $0x80111d80
...
801038eb:	68 80 1d 11 80       	push   $0x80111d80
...
8010390c:	e8 df ef ff ff       	call   801028f0 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103911:	8b 35 e4 17 11 80    	mov    0x801117e4,%esi
...
8010392d:	0f b6 99 00 18 11 80 	movzbl -0x7feee800(%ecx),%ebx
80103934:	39 c3                	cmp    %eax,%ebx
80103936:	75 e8                	jne    80103920 <mycpu+0x20>
}
80103938:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
8010393b:	8d 81 00 18 11 80    	lea    -0x7feee800(%ecx),%eax
}
80103941:	5b                   	pop    %ebx
80103942:	5e                   	pop    %esi
80103943:	5d                   	pop    %ebp
...
8010396b:	c9                   	leave  
  return mycpu()-cpus;
8010396c:	2d 00 18 11 80       	sub    $0x80111800,%eax
...
801039bc:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039be:	a3 b4 3d 11 80       	mov    %eax,0x80113db4
...
801039db:	68 c0 a4 10 80       	push   $0x8010a4c0
...
80103a66:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a69:	c7 04 24 80 1d 11 80 	movl   $0x80111d80,(%esp)
80103a70:	e8 3b 0b 00 00       	call   801045b0 <acquire>
  p->state = RUNNABLE;
80103a75:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a7c:	c7 04 24 80 1d 11 80 	movl   $0x80111d80,(%esp)
...
80103bd9:	e8 52 0c 00 00       	call   80104830 <safestrcpy>
  pid = np->pid;
80103bde:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103be1:	c7 04 24 80 1d 11 80 	movl   $0x80111d80,(%esp)
80103be8:	e8 c3 09 00 00       	call   801045b0 <acquire>
  np->state = RUNNABLE;
80103bed:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103bf4:	c7 04 24 80 1d 11 80 	movl   $0x80111d80,(%esp)
80103bfb:	e8 50 09 00 00       	call   80104550 <release>
  return pid;
...
80103c61:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c64:	bb b4 1d 11 80       	mov    $0x80111db4,%ebx
    acquire(&ptable.lock);
80103c69:	68 80 1d 11 80       	push   $0x80111d80
...
80103cbc:	81 fb b4 3d 11 80    	cmp    $0x80113db4,%ebx
80103cc2:	75 bc                	jne    80103c80 <scheduler+0x40>
    release(&ptable.lock);
80103cc4:	83 ec 0c             	sub    $0xc,%esp
80103cc7:	68 80 1d 11 80       	push   $0x80111d80
...
80103cfd:	68 80 1d 11 80       	push   $0x80111d80
...
80103da9:	e8 d2 fb ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
80103dae:	39 05 b4 3d 11 80    	cmp    %eax,0x80113db4
...
80103dfc:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103e03:	c7 04 24 80 1d 11 80 	movl   $0x80111d80,(%esp)
...
80103e3f:	3d b4 3d 11 80       	cmp    $0x80113db4,%eax
80103e44:	75 e4                	jne    80103e2a <exit+0x8a>
      p->parent = initproc;
80103e46:	8b 0d b4 3d 11 80    	mov    0x80113db4,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e4c:	ba b4 1d 11 80       	mov    $0x80111db4,%edx
80103e51:	eb 10                	jmp    80103e63 <exit+0xc3>
80103e53:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e57:	90                   	nop
80103e58:	83 ea 80             	sub    $0xffffff80,%edx
80103e5b:	81 fa b4 3d 11 80    	cmp    $0x80113db4,%edx
...
80103e6f:	75 e7                	jne    80103e58 <exit+0xb8>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e71:	b8 b4 1d 11 80       	mov    $0x80111db4,%eax
...
80103e83:	3d b4 3d 11 80       	cmp    $0x80113db4,%eax
...
80103f21:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f26:	81 fb b4 3d 11 80    	cmp    $0x80113db4,%ebx
...
80103fb7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103fbe:	c7 04 24 80 1d 11 80 	movl   $0x80111d80,(%esp)
...
80103fd9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103fde:	68 80 1d 11 80       	push   $0x80111d80
...
80104007:	68 80 1d 11 80       	push   $0x80111d80
...
8010402d:	e8 ae fc ff ff       	call   80103ce0 <sched>
  release(&ptable.lock);
80104032:	c7 04 24 80 1d 11 80 	movl   $0x80111d80,(%esp)
...
80104080:	81 fe 80 1d 11 80    	cmp    $0x80111d80,%esi
80104086:	74 50                	je     801040d8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104088:	83 ec 0c             	sub    $0xc,%esp
8010408b:	68 80 1d 11 80       	push   $0x80111d80
...
801040ac:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801040b3:	c7 04 24 80 1d 11 80 	movl   $0x80111d80,(%esp)
...
8010414f:	3d b4 3d 11 80       	cmp    $0x80113db4,%eax
80104154:	75 e4                	jne    8010413a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80104156:	c7 45 08 80 1d 11 80 	movl   $0x80111d80,0x8(%ebp)
}
...
801041b6:	68 80 1d 11 80       	push   $0x80111d80
...
801041d3:	68 80 1d 11 80       	push   $0x80111d80
...
801041f9:	bb 20 1e 11 80       	mov    $0x80111e20,%ebx
...
80104a7f:	8b 70 1c             	mov    0x1c(%eax),%esi
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104a82:	8d 46 ff             	lea    -0x1(%esi),%eax
80104a85:	83 f8 16             	cmp    $0x16,%eax
80104a88:	77 46                	ja     80104ad0 <syscall+0x60>
80104a8a:	8b 04 b5 80 79 10 80 	mov    -0x7fef8680(,%esi,4),%eax
80104a91:	85 c0                	test   %eax,%eax
80104a93:	74 3b                	je     80104ad0 <syscall+0x60>
    curproc->tf->eax = syscalls[num]();
80104a95:	ff d0                	call   *%eax
80104a97:	8b 53 18             	mov    0x18(%ebx),%edx
80104a9a:	89 42 1c             	mov    %eax,0x1c(%edx)
    if ((curproc->mask) > 0 && (curproc->mask >> num) & 1) {
80104a9d:	8b 43 7c             	mov    0x7c(%ebx),%eax
80104aa0:	85 c0                	test   %eax,%eax
80104aa2:	7e 4b                	jle    80104aef <syscall+0x7f>
80104aa4:	0f a3 f0             	bt     %esi,%eax
80104aa7:	73 46                	jae    80104aef <syscall+0x7f>
	    cprintf("syscall traced: pid = %d, syscall = %s, %d returned\n", curproc->pid, syscallnames[num], curproc->tf->eax);
80104aa9:	8b 43 18             	mov    0x18(%ebx),%eax
80104aac:	ff 70 1c             	push   0x1c(%eax)
80104aaf:	ff 34 b5 20 a0 10 80 	push   -0x7fef5fe0(,%esi,4)
80104ab6:	ff 73 10             	push   0x10(%ebx)
80104ab9:	68 c0 78 10 80       	push   $0x801078c0
80104abe:	e8 dd bb ff ff       	call   801006a0 <cprintf>
80104ac3:	83 c4 10             	add    $0x10,%esp
80104ac6:	eb 27                	jmp    80104aef <syscall+0x7f>
...
80104ad0:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104ad3:	56                   	push   %esi
80104ad4:	50                   	push   %eax
80104ad5:	ff 73 10             	push   0x10(%ebx)
80104ad8:	68 f5 78 10 80       	push   $0x801078f5
...
80104cae:	e8 7d fc ff ff       	call   80104930 <argint>
...
80104d2e:	e8 fd fb ff ff       	call   80104930 <argint>
...
80104d59:	e8 d2 fb ff ff       	call   80104930 <argint>
...
80104d6e:	e8 0d fc ff ff       	call   80104980 <argptr>
...
80104dae:	e8 7d fb ff ff       	call   80104930 <argint>
...
80104dd9:	e8 52 fb ff ff       	call   80104930 <argint>
...
80104dee:	e8 8d fb ff ff       	call   80104980 <argptr>
...
80104e2e:	e8 fd fa ff ff       	call   80104930 <argint>
...
80104e8e:	e8 9d fa ff ff       	call   80104930 <argint>
...
80104eb8:	e8 c3 fa ff ff       	call   80104980 <argptr>
...
80104eff:	e8 ec fa ff ff       	call   801049f0 <argstr>
...
80104f18:	e8 d3 fa ff ff       	call   801049f0 <argstr>
...
8010504f:	e8 9c f9 ff ff       	call   801049f0 <argstr>
...
80105102:	e8 69 f5 ff ff       	call   80104670 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
8010522f:	e8 bc f7 ff ff       	call   801049f0 <argstr>
...
80105248:	e8 e3 f6 ff ff       	call   80104930 <argint>
...
801053d4:	e8 17 f6 ff ff       	call   801049f0 <argstr>
...
80105455:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105458:	e8 23 e5 ff ff       	call   80103980 <myproc>
...
8010546d:	e8 7e f5 ff ff       	call   801049f0 <argstr>
...
80105515:	e8 d6 f4 ff ff       	call   801049f0 <argstr>
...
80105531:	e8 fa f3 ff ff       	call   80104930 <argint>
...
80105550:	e8 1b f1 ff ff       	call   80104670 <memset>
...
8010557a:	e8 21 f3 ff ff       	call   801048a0 <fetchint>
...
80105598:	e8 43 f3 ff ff       	call   801048e0 <fetchstr>
...
80105601:	e8 7a f3 ff ff       	call   80104980 <argptr>
...
{
  return fork();
801056c0:	e9 5b e4 ff ff       	jmp    80103b20 <fork>
...
80105733:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105736:	e8 45 e2 ff ff       	call   80103980 <myproc>
...
80105766:	e8 35 e3 ff ff       	call   80103aa0 <growproc>
...
801057b0:	68 e0 3d 11 80       	push   $0x80113de0
801057b5:	e8 f6 ed ff ff       	call   801045b0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801057ba:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801057bd:	8b 1d c0 3d 11 80    	mov    0x80113dc0,%ebx
  while(ticks - ticks0 < n){
...
801057d3:	68 e0 3d 11 80       	push   $0x80113de0
801057d8:	68 c0 3d 11 80       	push   $0x80113dc0
801057dd:	e8 6e e8 ff ff       	call   80104050 <sleep>
  while(ticks - ticks0 < n){
801057e2:	a1 c0 3d 11 80       	mov    0x80113dc0,%eax
...
801057ef:	73 2f                	jae    80105820 <sys_sleep+0x90>
    if(myproc()->killed){
801057f1:	e8 8a e1 ff ff       	call   80103980 <myproc>
...
80105800:	68 e0 3d 11 80       	push   $0x80113de0
...
80105823:	68 e0 3d 11 80       	push   $0x80113de0
...
80105844:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105847:	68 e0 3d 11 80       	push   $0x80113de0
8010584c:	e8 5f ed ff ff       	call   801045b0 <acquire>
  xticks = ticks;
80105851:	8b 1d c0 3d 11 80    	mov    0x80113dc0,%ebx
  release(&tickslock);
80105857:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
...
801058f0:	8b 14 85 80 a0 10 80 	mov    -0x7fef5f80(,%eax,4),%edx
801058f7:	c7 04 c5 22 3e 11 80 	movl   $0x8e000008,-0x7feec1de(,%eax,8)
801058fe:	08 00 00 8e 
80105902:	66 89 14 c5 20 3e 11 	mov    %dx,-0x7feec1e0(,%eax,8)
80105909:	80 
8010590a:	c1 ea 10             	shr    $0x10,%edx
8010590d:	66 89 14 c5 26 3e 11 	mov    %dx,-0x7feec1da(,%eax,8)
80105914:	80 
  for(i = 0; i < 256; i++)
...
8010591f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105922:	a1 80 a1 10 80       	mov    0x8010a180,%eax
80105927:	c7 05 22 40 11 80 08 	movl   $0xef000008,0x80114022
8010592e:	00 00 ef 
  initlock(&tickslock, "time");
80105931:	68 3f 79 10 80       	push   $0x8010793f
80105936:	68 e0 3d 11 80       	push   $0x80113de0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010593b:	66 a3 20 40 11 80    	mov    %ax,0x80114020
80105941:	c1 e8 10             	shr    $0x10,%eax
80105944:	66 a3 26 40 11 80    	mov    %ax,0x80114026
  initlock(&tickslock, "time");
...
8010596b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010596f:	b8 20 3e 11 80       	mov    $0x80113e20,%eax
...
801059b4:	ff 24 85 e4 7a 10 80 	jmp    *-0x7fef851c(,%eax,4)
...
80105a95:	68 a0 7a 10 80       	push   $0x80107aa0
...
80105ae7:	68 48 7a 10 80       	push   $0x80107a48
...
80105ba0:	68 e0 3d 11 80       	push   $0x80113de0
80105ba5:	e8 06 ea ff ff       	call   801045b0 <acquire>
      wakeup(&ticks);
80105baa:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
      ticks++;
80105bb1:	83 05 c0 3d 11 80 01 	addl   $0x1,0x80113dc0
      wakeup(&ticks);
80105bb8:	e8 53 e5 ff ff       	call   80104110 <wakeup>
      release(&tickslock);
80105bbd:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
...
80105c03:	68 6c 7a 10 80       	push   $0x80107a6c
80105c08:	e8 93 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105c0d:	83 c4 14             	add    $0x14,%esp
80105c10:	68 41 7a 10 80       	push   $0x80107a41
...
{
  if(!uart)
80105c20:	a1 20 46 11 80       	mov    0x80114620,%eax
...
80105ca7:	74 78                	je     80105d21 <uartinit+0xd1>
  uart = 1;
80105ca9:	c7 05 20 46 11 80 01 	movl   $0x1,0x80114620
80105cb0:	00 00 00 
...
80105cbc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105cbf:	bf 64 7b 10 80       	mov    $0x80107b64,%edi
...
80105cd9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105ce0:	a1 20 46 11 80       	mov    0x80114620,%eax
...
80105d30 <uartputc>:
  if(!uart)
80105d30:	a1 20 46 11 80       	mov    0x80114620,%eax
...
80105da7:	6a 00                	push   $0x0
  jmp alltraps
80105da9:	e9 09 fb ff ff       	jmp    801058b7 <alltraps>
...
80105db0:	6a 01                	push   $0x1
  jmp alltraps
80105db2:	e9 00 fb ff ff       	jmp    801058b7 <alltraps>
...
80105db9:	6a 02                	push   $0x2
  jmp alltraps
80105dbb:	e9 f7 fa ff ff       	jmp    801058b7 <alltraps>
...
80105dc2:	6a 03                	push   $0x3
  jmp alltraps
80105dc4:	e9 ee fa ff ff       	jmp    801058b7 <alltraps>
...
80105dd4:	6a 05                	push   $0x5
  jmp alltraps
80105dd6:	e9 dc fa ff ff       	jmp    801058b7 <alltraps>
...
80105df6:	6a 09                	push   $0x9
  jmp alltraps
80105df8:	e9 ba fa ff ff       	jmp    801058b7 <alltraps>
...
80105dfd:	6a 0a                	push   $0xa
  jmp alltraps
80105dff:	e9 b3 fa ff ff       	jmp    801058b7 <alltraps>
...
80105e0b:	6a 0c                	push   $0xc
  jmp alltraps
80105e0d:	e9 a5 fa ff ff       	jmp    801058b7 <alltraps>
...
80105e19:	6a 0e                	push   $0xe
  jmp alltraps
80105e1b:	e9 97 fa ff ff       	jmp    801058b7 <alltraps>
...
80105e5f:	6a 16                	push   $0x16
  jmp alltraps
80105e61:	e9 51 fa ff ff       	jmp    801058b7 <alltraps>
...
80105e68:	6a 17                	push   $0x17
  jmp alltraps
80105e6a:	e9 48 fa ff ff       	jmp    801058b7 <alltraps>
...
80105e71:	6a 18                	push   $0x18
  jmp alltraps
80105e73:	e9 3f fa ff ff       	jmp    801058b7 <alltraps>
...
80105e7a:	6a 19                	push   $0x19
  jmp alltraps
80105e7c:	e9 36 fa ff ff       	jmp    801058b7 <alltraps>
...
80105e83:	6a 1a                	push   $0x1a
  jmp alltraps
80105e85:	e9 2d fa ff ff       	jmp    801058b7 <alltraps>
...
80105e8c:	6a 1b                	push   $0x1b
  jmp alltraps
80105e8e:	e9 24 fa ff ff       	jmp    801058b7 <alltraps>
...
80105e95:	6a 1c                	push   $0x1c
  jmp alltraps
80105e97:	e9 1b fa ff ff       	jmp    801058b7 <alltraps>
...
80105e9e:	6a 1d                	push   $0x1d
  jmp alltraps
80105ea0:	e9 12 fa ff ff       	jmp    801058b7 <alltraps>
...
80105ea7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ea9:	e9 09 fa ff ff       	jmp    801058b7 <alltraps>
...
80105eb0:	6a 1f                	push   $0x1f
  jmp alltraps
80105eb2:	e9 00 fa ff ff       	jmp    801058b7 <alltraps>
...
80105eb9:	6a 20                	push   $0x20
  jmp alltraps
80105ebb:	e9 f7 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105ec2:	6a 21                	push   $0x21
  jmp alltraps
80105ec4:	e9 ee f9 ff ff       	jmp    801058b7 <alltraps>
...
80105ecb:	6a 22                	push   $0x22
  jmp alltraps
80105ecd:	e9 e5 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105ed4:	6a 23                	push   $0x23
  jmp alltraps
80105ed6:	e9 dc f9 ff ff       	jmp    801058b7 <alltraps>
...
80105edd:	6a 24                	push   $0x24
  jmp alltraps
80105edf:	e9 d3 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105ee6:	6a 25                	push   $0x25
  jmp alltraps
80105ee8:	e9 ca f9 ff ff       	jmp    801058b7 <alltraps>
...
80105eef:	6a 26                	push   $0x26
  jmp alltraps
80105ef1:	e9 c1 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105ef8:	6a 27                	push   $0x27
  jmp alltraps
80105efa:	e9 b8 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f01:	6a 28                	push   $0x28
  jmp alltraps
80105f03:	e9 af f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f0a:	6a 29                	push   $0x29
  jmp alltraps
80105f0c:	e9 a6 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f13:	6a 2a                	push   $0x2a
  jmp alltraps
80105f15:	e9 9d f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f1c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f1e:	e9 94 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f25:	6a 2c                	push   $0x2c
  jmp alltraps
80105f27:	e9 8b f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f2e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f30:	e9 82 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f37:	6a 2e                	push   $0x2e
  jmp alltraps
80105f39:	e9 79 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f40:	6a 2f                	push   $0x2f
  jmp alltraps
80105f42:	e9 70 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f49:	6a 30                	push   $0x30
  jmp alltraps
80105f4b:	e9 67 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f52:	6a 31                	push   $0x31
  jmp alltraps
80105f54:	e9 5e f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f5b:	6a 32                	push   $0x32
  jmp alltraps
80105f5d:	e9 55 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f64:	6a 33                	push   $0x33
  jmp alltraps
80105f66:	e9 4c f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f6d:	6a 34                	push   $0x34
  jmp alltraps
80105f6f:	e9 43 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f76:	6a 35                	push   $0x35
  jmp alltraps
80105f78:	e9 3a f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f7f:	6a 36                	push   $0x36
  jmp alltraps
80105f81:	e9 31 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f88:	6a 37                	push   $0x37
  jmp alltraps
80105f8a:	e9 28 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f91:	6a 38                	push   $0x38
  jmp alltraps
80105f93:	e9 1f f9 ff ff       	jmp    801058b7 <alltraps>
...
80105f9a:	6a 39                	push   $0x39
  jmp alltraps
80105f9c:	e9 16 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105fa3:	6a 3a                	push   $0x3a
  jmp alltraps
80105fa5:	e9 0d f9 ff ff       	jmp    801058b7 <alltraps>
...
80105fac:	6a 3b                	push   $0x3b
  jmp alltraps
80105fae:	e9 04 f9 ff ff       	jmp    801058b7 <alltraps>
...
80105fb5:	6a 3c                	push   $0x3c
  jmp alltraps
80105fb7:	e9 fb f8 ff ff       	jmp    801058b7 <alltraps>
...
80105fbe:	6a 3d                	push   $0x3d
  jmp alltraps
80105fc0:	e9 f2 f8 ff ff       	jmp    801058b7 <alltraps>
...
80105fc7:	6a 3e                	push   $0x3e
  jmp alltraps
80105fc9:	e9 e9 f8 ff ff       	jmp    801058b7 <alltraps>
...
80105fd0:	6a 3f                	push   $0x3f
  jmp alltraps
80105fd2:	e9 e0 f8 ff ff       	jmp    801058b7 <alltraps>
...
80105fd9:	6a 40                	push   $0x40
  jmp alltraps
80105fdb:	e9 d7 f8 ff ff       	jmp    801058b7 <alltraps>
...
80105fe2:	6a 41                	push   $0x41
  jmp alltraps
80105fe4:	e9 ce f8 ff ff       	jmp    801058b7 <alltraps>
...
80105feb:	6a 42                	push   $0x42
  jmp alltraps
80105fed:	e9 c5 f8 ff ff       	jmp    801058b7 <alltraps>
...
80105ff4:	6a 43                	push   $0x43
  jmp alltraps
80105ff6:	e9 bc f8 ff ff       	jmp    801058b7 <alltraps>
...
80105ffd:	6a 44                	push   $0x44
  jmp alltraps
80105fff:	e9 b3 f8 ff ff       	jmp    801058b7 <alltraps>
...
80106006:	6a 45                	push   $0x45
  jmp alltraps
80106008:	e9 aa f8 ff ff       	jmp    801058b7 <alltraps>
...
8010600f:	6a 46                	push   $0x46
  jmp alltraps
80106011:	e9 a1 f8 ff ff       	jmp    801058b7 <alltraps>
...
80106018:	6a 47                	push   $0x47
  jmp alltraps
8010601a:	e9 98 f8 ff ff       	jmp    801058b7 <alltraps>
...
80106021:	6a 48                	push   $0x48
  jmp alltraps
80106023:	e9 8f f8 ff ff       	jmp    801058b7 <alltraps>
...
8010602a:	6a 49                	push   $0x49
  jmp alltraps
8010602c:	e9 86 f8 ff ff       	jmp    801058b7 <alltraps>
...
80106033:	6a 4a                	push   $0x4a
  jmp alltraps
80106035:	e9 7d f8 ff ff       	jmp    801058b7 <alltraps>
...
8010603c:	6a 4b                	push   $0x4b
  jmp alltraps
8010603e:	e9 74 f8 ff ff       	jmp    801058b7 <alltraps>
...
80106045:	6a 4c                	push   $0x4c
  jmp alltraps
80106047:	e9 6b f8 ff ff       	jmp    801058b7 <alltraps>
...
8010604e:	6a 4d                	push   $0x4d
  jmp alltraps
80106050:	e9 62 f8 ff ff       	jmp    801058b7 <alltraps>
...
80106057:	6a 4e                	push   $0x4e
  jmp alltraps
80106059:	e9 59 f8 ff ff       	jmp    801058b7 <alltraps>
...
80106060:	6a 4f                	push   $0x4f
  jmp alltraps
80106062:	e9 50 f8 ff ff       	jmp    801058b7 <alltraps>
...
80106069:	6a 50                	push   $0x50
  jmp alltraps
8010606b:	e9 47 f8 ff ff       	jmp    801058b7 <alltraps>
...
80106072:	6a 51                	push   $0x51
  jmp alltraps
80106074:	e9 3e f8 ff ff       	jmp    801058b7 <alltraps>
...
8010607b:	6a 52                	push   $0x52
  jmp alltraps
8010607d:	e9 35 f8 ff ff       	jmp    801058b7 <alltraps>
...
80106084:	6a 53                	push   $0x53
  jmp alltraps
80106086:	e9 2c f8 ff ff       	jmp    801058b7 <alltraps>
...
8010608d:	6a 54                	push   $0x54
  jmp alltraps
8010608f:	e9 23 f8 ff ff       	jmp    801058b7 <alltraps>
...
80106096:	6a 55                	push   $0x55
  jmp alltraps
80106098:	e9 1a f8 ff ff       	jmp    801058b7 <alltraps>
...
8010609f:	6a 56                	push   $0x56
  jmp alltraps
801060a1:	e9 11 f8 ff ff       	jmp    801058b7 <alltraps>
...
801060a8:	6a 57                	push   $0x57
  jmp alltraps
801060aa:	e9 08 f8 ff ff       	jmp    801058b7 <alltraps>
...
801060b1:	6a 58                	push   $0x58
  jmp alltraps
801060b3:	e9 ff f7 ff ff       	jmp    801058b7 <alltraps>
...
801060ba:	6a 59                	push   $0x59
  jmp alltraps
801060bc:	e9 f6 f7 ff ff       	jmp    801058b7 <alltraps>
...
801060c3:	6a 5a                	push   $0x5a
  jmp alltraps
801060c5:	e9 ed f7 ff ff       	jmp    801058b7 <alltraps>
...
801060cc:	6a 5b                	push   $0x5b
  jmp alltraps
801060ce:	e9 e4 f7 ff ff       	jmp    801058b7 <alltraps>
...
801060d5:	6a 5c                	push   $0x5c
  jmp alltraps
801060d7:	e9 db f7 ff ff       	jmp    801058b7 <alltraps>
...
801060de:	6a 5d                	push   $0x5d
  jmp alltraps
801060e0:	e9 d2 f7 ff ff       	jmp    801058b7 <alltraps>
...
801060e7:	6a 5e                	push   $0x5e
  jmp alltraps
801060e9:	e9 c9 f7 ff ff       	jmp    801058b7 <alltraps>
...
801060f0:	6a 5f                	push   $0x5f
  jmp alltraps
801060f2:	e9 c0 f7 ff ff       	jmp    801058b7 <alltraps>
...
801060f9:	6a 60                	push   $0x60
  jmp alltraps
801060fb:	e9 b7 f7 ff ff       	jmp    801058b7 <alltraps>
...
80106102:	6a 61                	push   $0x61
  jmp alltraps
80106104:	e9 ae f7 ff ff       	jmp    801058b7 <alltraps>
...
8010610b:	6a 62                	push   $0x62
  jmp alltraps
8010610d:	e9 a5 f7 ff ff       	jmp    801058b7 <alltraps>
...
80106114:	6a 63                	push   $0x63
  jmp alltraps
80106116:	e9 9c f7 ff ff       	jmp    801058b7 <alltraps>
...
8010611d:	6a 64                	push   $0x64
  jmp alltraps
8010611f:	e9 93 f7 ff ff       	jmp    801058b7 <alltraps>
...
80106126:	6a 65                	push   $0x65
  jmp alltraps
80106128:	e9 8a f7 ff ff       	jmp    801058b7 <alltraps>
...
8010612f:	6a 66                	push   $0x66
  jmp alltraps
80106131:	e9 81 f7 ff ff       	jmp    801058b7 <alltraps>
...
80106138:	6a 67                	push   $0x67
  jmp alltraps
8010613a:	e9 78 f7 ff ff       	jmp    801058b7 <alltraps>
...
80106141:	6a 68                	push   $0x68
  jmp alltraps
80106143:	e9 6f f7 ff ff       	jmp    801058b7 <alltraps>
...
8010614a:	6a 69                	push   $0x69
  jmp alltraps
8010614c:	e9 66 f7 ff ff       	jmp    801058b7 <alltraps>
...
80106153:	6a 6a                	push   $0x6a
  jmp alltraps
80106155:	e9 5d f7 ff ff       	jmp    801058b7 <alltraps>
...
8010615c:	6a 6b                	push   $0x6b
  jmp alltraps
8010615e:	e9 54 f7 ff ff       	jmp    801058b7 <alltraps>
...
80106165:	6a 6c                	push   $0x6c
  jmp alltraps
80106167:	e9 4b f7 ff ff       	jmp    801058b7 <alltraps>
...
8010616e:	6a 6d                	push   $0x6d
  jmp alltraps
80106170:	e9 42 f7 ff ff       	jmp    801058b7 <alltraps>
...
80106177:	6a 6e                	push   $0x6e
  jmp alltraps
80106179:	e9 39 f7 ff ff       	jmp    801058b7 <alltraps>
...
80106180:	6a 6f                	push   $0x6f
  jmp alltraps
80106182:	e9 30 f7 ff ff       	jmp    801058b7 <alltraps>
...
80106189:	6a 70                	push   $0x70
  jmp alltraps
8010618b:	e9 27 f7 ff ff       	jmp    801058b7 <alltraps>
...
80106192:	6a 71                	push   $0x71
  jmp alltraps
80106194:	e9 1e f7 ff ff       	jmp    801058b7 <alltraps>
...
8010619b:	6a 72                	push   $0x72
  jmp alltraps
8010619d:	e9 15 f7 ff ff       	jmp    801058b7 <alltraps>
...
801061a4:	6a 73                	push   $0x73
  jmp alltraps
801061a6:	e9 0c f7 ff ff       	jmp    801058b7 <alltraps>
...
801061ad:	6a 74                	push   $0x74
  jmp alltraps
801061af:	e9 03 f7 ff ff       	jmp    801058b7 <alltraps>
...
801061b6:	6a 75                	push   $0x75
  jmp alltraps
801061b8:	e9 fa f6 ff ff       	jmp    801058b7 <alltraps>
...
801061bf:	6a 76                	push   $0x76
  jmp alltraps
801061c1:	e9 f1 f6 ff ff       	jmp    801058b7 <alltraps>
...
801061c8:	6a 77                	push   $0x77
  jmp alltraps
801061ca:	e9 e8 f6 ff ff       	jmp    801058b7 <alltraps>
...
801061d1:	6a 78                	push   $0x78
  jmp alltraps
801061d3:	e9 df f6 ff ff       	jmp    801058b7 <alltraps>
...
801061da:	6a 79                	push   $0x79
  jmp alltraps
801061dc:	e9 d6 f6 ff ff       	jmp    801058b7 <alltraps>
...
801061e3:	6a 7a                	push   $0x7a
  jmp alltraps
801061e5:	e9 cd f6 ff ff       	jmp    801058b7 <alltraps>
...
801061ec:	6a 7b                	push   $0x7b
  jmp alltraps
801061ee:	e9 c4 f6 ff ff       	jmp    801058b7 <alltraps>
...
801061f5:	6a 7c                	push   $0x7c
  jmp alltraps
801061f7:	e9 bb f6 ff ff       	jmp    801058b7 <alltraps>
...
801061fe:	6a 7d                	push   $0x7d
  jmp alltraps
80106200:	e9 b2 f6 ff ff       	jmp    801058b7 <alltraps>
...
80106207:	6a 7e                	push   $0x7e
  jmp alltraps
80106209:	e9 a9 f6 ff ff       	jmp    801058b7 <alltraps>
...
80106210:	6a 7f                	push   $0x7f
  jmp alltraps
80106212:	e9 a0 f6 ff ff       	jmp    801058b7 <alltraps>
...
80106219:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010621e:	e9 94 f6 ff ff       	jmp    801058b7 <alltraps>
...
80106225:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010622a:	e9 88 f6 ff ff       	jmp    801058b7 <alltraps>
...
80106231:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106236:	e9 7c f6 ff ff       	jmp    801058b7 <alltraps>
...
8010623d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106242:	e9 70 f6 ff ff       	jmp    801058b7 <alltraps>
...
80106249:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010624e:	e9 64 f6 ff ff       	jmp    801058b7 <alltraps>
...
80106255:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010625a:	e9 58 f6 ff ff       	jmp    801058b7 <alltraps>
...
80106261:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106266:	e9 4c f6 ff ff       	jmp    801058b7 <alltraps>
...
8010626d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106272:	e9 40 f6 ff ff       	jmp    801058b7 <alltraps>
...
80106279:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010627e:	e9 34 f6 ff ff       	jmp    801058b7 <alltraps>
...
80106285:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010628a:	e9 28 f6 ff ff       	jmp    801058b7 <alltraps>
...
80106291:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106296:	e9 1c f6 ff ff       	jmp    801058b7 <alltraps>
...
8010629d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801062a2:	e9 10 f6 ff ff       	jmp    801058b7 <alltraps>
...
801062a9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801062ae:	e9 04 f6 ff ff       	jmp    801058b7 <alltraps>
...
801062b5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801062ba:	e9 f8 f5 ff ff       	jmp    801058b7 <alltraps>
...
801062c1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062c6:	e9 ec f5 ff ff       	jmp    801058b7 <alltraps>
...
801062cd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801062d2:	e9 e0 f5 ff ff       	jmp    801058b7 <alltraps>
...
801062d9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801062de:	e9 d4 f5 ff ff       	jmp    801058b7 <alltraps>
...
801062e5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801062ea:	e9 c8 f5 ff ff       	jmp    801058b7 <alltraps>
...
801062f1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801062f6:	e9 bc f5 ff ff       	jmp    801058b7 <alltraps>
...
801062fd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106302:	e9 b0 f5 ff ff       	jmp    801058b7 <alltraps>
...
80106309:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010630e:	e9 a4 f5 ff ff       	jmp    801058b7 <alltraps>
...
80106315:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010631a:	e9 98 f5 ff ff       	jmp    801058b7 <alltraps>
...
80106321:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106326:	e9 8c f5 ff ff       	jmp    801058b7 <alltraps>
...
8010632d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106332:	e9 80 f5 ff ff       	jmp    801058b7 <alltraps>
...
80106339:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010633e:	e9 74 f5 ff ff       	jmp    801058b7 <alltraps>
...
80106345:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010634a:	e9 68 f5 ff ff       	jmp    801058b7 <alltraps>
...
80106351:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106356:	e9 5c f5 ff ff       	jmp    801058b7 <alltraps>
...
8010635d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106362:	e9 50 f5 ff ff       	jmp    801058b7 <alltraps>
...
80106369:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010636e:	e9 44 f5 ff ff       	jmp    801058b7 <alltraps>
...
80106375:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010637a:	e9 38 f5 ff ff       	jmp    801058b7 <alltraps>
...
80106381:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106386:	e9 2c f5 ff ff       	jmp    801058b7 <alltraps>
...
8010638d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106392:	e9 20 f5 ff ff       	jmp    801058b7 <alltraps>
...
80106399:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010639e:	e9 14 f5 ff ff       	jmp    801058b7 <alltraps>
...
801063a5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801063aa:	e9 08 f5 ff ff       	jmp    801058b7 <alltraps>
...
801063b1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801063b6:	e9 fc f4 ff ff       	jmp    801058b7 <alltraps>
...
801063bd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063c2:	e9 f0 f4 ff ff       	jmp    801058b7 <alltraps>
...
801063c9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801063ce:	e9 e4 f4 ff ff       	jmp    801058b7 <alltraps>
...
801063d5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801063da:	e9 d8 f4 ff ff       	jmp    801058b7 <alltraps>
...
801063e1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801063e6:	e9 cc f4 ff ff       	jmp    801058b7 <alltraps>
...
801063ed:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801063f2:	e9 c0 f4 ff ff       	jmp    801058b7 <alltraps>
...
801063f9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801063fe:	e9 b4 f4 ff ff       	jmp    801058b7 <alltraps>
...
80106405:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010640a:	e9 a8 f4 ff ff       	jmp    801058b7 <alltraps>
...
80106411:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106416:	e9 9c f4 ff ff       	jmp    801058b7 <alltraps>
...
8010641d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106422:	e9 90 f4 ff ff       	jmp    801058b7 <alltraps>
...
80106429:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010642e:	e9 84 f4 ff ff       	jmp    801058b7 <alltraps>
...
80106435:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010643a:	e9 78 f4 ff ff       	jmp    801058b7 <alltraps>
...
80106441:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106446:	e9 6c f4 ff ff       	jmp    801058b7 <alltraps>
...
8010644d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106452:	e9 60 f4 ff ff       	jmp    801058b7 <alltraps>
...
80106459:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010645e:	e9 54 f4 ff ff       	jmp    801058b7 <alltraps>
...
80106465:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010646a:	e9 48 f4 ff ff       	jmp    801058b7 <alltraps>
...
80106471:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106476:	e9 3c f4 ff ff       	jmp    801058b7 <alltraps>
...
8010647d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106482:	e9 30 f4 ff ff       	jmp    801058b7 <alltraps>
...
80106489:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010648e:	e9 24 f4 ff ff       	jmp    801058b7 <alltraps>
...
80106495:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010649a:	e9 18 f4 ff ff       	jmp    801058b7 <alltraps>
...
801064a1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801064a6:	e9 0c f4 ff ff       	jmp    801058b7 <alltraps>
...
801064ad:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801064b2:	e9 00 f4 ff ff       	jmp    801058b7 <alltraps>
...
801064b9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801064be:	e9 f4 f3 ff ff       	jmp    801058b7 <alltraps>
...
801064c5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801064ca:	e9 e8 f3 ff ff       	jmp    801058b7 <alltraps>
...
801064d1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801064d6:	e9 dc f3 ff ff       	jmp    801058b7 <alltraps>
...
801064dd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801064e2:	e9 d0 f3 ff ff       	jmp    801058b7 <alltraps>
...
801064e9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801064ee:	e9 c4 f3 ff ff       	jmp    801058b7 <alltraps>
...
801064f5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801064fa:	e9 b8 f3 ff ff       	jmp    801058b7 <alltraps>
...
80106501:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106506:	e9 ac f3 ff ff       	jmp    801058b7 <alltraps>
...
8010650d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106512:	e9 a0 f3 ff ff       	jmp    801058b7 <alltraps>
...
80106519:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010651e:	e9 94 f3 ff ff       	jmp    801058b7 <alltraps>
...
80106525:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010652a:	e9 88 f3 ff ff       	jmp    801058b7 <alltraps>
...
80106531:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106536:	e9 7c f3 ff ff       	jmp    801058b7 <alltraps>
...
8010653d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106542:	e9 70 f3 ff ff       	jmp    801058b7 <alltraps>
...
80106549:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010654e:	e9 64 f3 ff ff       	jmp    801058b7 <alltraps>
...
80106555:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010655a:	e9 58 f3 ff ff       	jmp    801058b7 <alltraps>
...
80106561:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106566:	e9 4c f3 ff ff       	jmp    801058b7 <alltraps>
...
8010656d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106572:	e9 40 f3 ff ff       	jmp    801058b7 <alltraps>
...
80106579:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010657e:	e9 34 f3 ff ff       	jmp    801058b7 <alltraps>
...
80106585:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010658a:	e9 28 f3 ff ff       	jmp    801058b7 <alltraps>
...
80106591:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106596:	e9 1c f3 ff ff       	jmp    801058b7 <alltraps>
...
8010659d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801065a2:	e9 10 f3 ff ff       	jmp    801058b7 <alltraps>
...
801065a9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801065ae:	e9 04 f3 ff ff       	jmp    801058b7 <alltraps>
...
801065b5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801065ba:	e9 f8 f2 ff ff       	jmp    801058b7 <alltraps>
...
801065c1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801065c6:	e9 ec f2 ff ff       	jmp    801058b7 <alltraps>
...
801065cd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801065d2:	e9 e0 f2 ff ff       	jmp    801058b7 <alltraps>
...
801065d9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801065de:	e9 d4 f2 ff ff       	jmp    801058b7 <alltraps>
...
801065e5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801065ea:	e9 c8 f2 ff ff       	jmp    801058b7 <alltraps>
...
801065f1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801065f6:	e9 bc f2 ff ff       	jmp    801058b7 <alltraps>
...
801065fd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106602:	e9 b0 f2 ff ff       	jmp    801058b7 <alltraps>
...
80106609:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010660e:	e9 a4 f2 ff ff       	jmp    801058b7 <alltraps>
...
80106615:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010661a:	e9 98 f2 ff ff       	jmp    801058b7 <alltraps>
...
80106621:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106626:	e9 8c f2 ff ff       	jmp    801058b7 <alltraps>
...
8010662d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106632:	e9 80 f2 ff ff       	jmp    801058b7 <alltraps>
...
80106639:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010663e:	e9 74 f2 ff ff       	jmp    801058b7 <alltraps>
...
80106645:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010664a:	e9 68 f2 ff ff       	jmp    801058b7 <alltraps>
...
80106651:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106656:	e9 5c f2 ff ff       	jmp    801058b7 <alltraps>
...
8010665d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106662:	e9 50 f2 ff ff       	jmp    801058b7 <alltraps>
...
80106669:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010666e:	e9 44 f2 ff ff       	jmp    801058b7 <alltraps>
...
80106675:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010667a:	e9 38 f2 ff ff       	jmp    801058b7 <alltraps>
...
80106681:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106686:	e9 2c f2 ff ff       	jmp    801058b7 <alltraps>
...
8010668d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106692:	e9 20 f2 ff ff       	jmp    801058b7 <alltraps>
...
80106699:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010669e:	e9 14 f2 ff ff       	jmp    801058b7 <alltraps>
...
801066a5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801066aa:	e9 08 f2 ff ff       	jmp    801058b7 <alltraps>
...
801066b1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801066b6:	e9 fc f1 ff ff       	jmp    801058b7 <alltraps>
...
801066bd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801066c2:	e9 f0 f1 ff ff       	jmp    801058b7 <alltraps>
...
801066c9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801066ce:	e9 e4 f1 ff ff       	jmp    801058b7 <alltraps>
...
801066d5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801066da:	e9 d8 f1 ff ff       	jmp    801058b7 <alltraps>
...
801066e1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801066e6:	e9 cc f1 ff ff       	jmp    801058b7 <alltraps>
...
801066ed:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801066f2:	e9 c0 f1 ff ff       	jmp    801058b7 <alltraps>
...
801066f9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801066fe:	e9 b4 f1 ff ff       	jmp    801058b7 <alltraps>
...
80106705:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010670a:	e9 a8 f1 ff ff       	jmp    801058b7 <alltraps>
...
80106711:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106716:	e9 9c f1 ff ff       	jmp    801058b7 <alltraps>
...
8010671d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106722:	e9 90 f1 ff ff       	jmp    801058b7 <alltraps>
...
80106729:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010672e:	e9 84 f1 ff ff       	jmp    801058b7 <alltraps>
...
80106735:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010673a:	e9 78 f1 ff ff       	jmp    801058b7 <alltraps>
...
80106741:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106746:	e9 6c f1 ff ff       	jmp    801058b7 <alltraps>
...
8010674d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106752:	e9 60 f1 ff ff       	jmp    801058b7 <alltraps>
...
80106759:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010675e:	e9 54 f1 ff ff       	jmp    801058b7 <alltraps>
...
80106765:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010676a:	e9 48 f1 ff ff       	jmp    801058b7 <alltraps>
...
80106771:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106776:	e9 3c f1 ff ff       	jmp    801058b7 <alltraps>
...
8010677d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106782:	e9 30 f1 ff ff       	jmp    801058b7 <alltraps>
...
80106789:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010678e:	e9 24 f1 ff ff       	jmp    801058b7 <alltraps>
...
80106795:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010679a:	e9 18 f1 ff ff       	jmp    801058b7 <alltraps>
...
801067a1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801067a6:	e9 0c f1 ff ff       	jmp    801058b7 <alltraps>
...
801067ad:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801067b2:	e9 00 f1 ff ff       	jmp    801058b7 <alltraps>
...
801067b9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801067be:	e9 f4 f0 ff ff       	jmp    801058b7 <alltraps>
...
801067c5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067ca:	e9 e8 f0 ff ff       	jmp    801058b7 <alltraps>
...
801067d1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801067d6:	e9 dc f0 ff ff       	jmp    801058b7 <alltraps>
...
801067dd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801067e2:	e9 d0 f0 ff ff       	jmp    801058b7 <alltraps>
...
801067e9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801067ee:	e9 c4 f0 ff ff       	jmp    801058b7 <alltraps>
...
801067f5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801067fa:	e9 b8 f0 ff ff       	jmp    801058b7 <alltraps>
...
80106801:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106806:	e9 ac f0 ff ff       	jmp    801058b7 <alltraps>
...
8010680d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106812:	e9 a0 f0 ff ff       	jmp    801058b7 <alltraps>
...
801069ad:	68 6c 7b 10 80       	push   $0x80107b6c
...
801069da:	c7 80 78 18 11 80 ff 	movl   $0xffff,-0x7feee788(%eax)
801069e1:	ff 00 00 
801069e4:	c7 80 7c 18 11 80 00 	movl   $0xcf9a00,-0x7feee784(%eax)
801069eb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801069ee:	c7 80 80 18 11 80 ff 	movl   $0xffff,-0x7feee780(%eax)
801069f5:	ff 00 00 
801069f8:	c7 80 84 18 11 80 00 	movl   $0xcf9200,-0x7feee77c(%eax)
801069ff:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106a02:	c7 80 88 18 11 80 ff 	movl   $0xffff,-0x7feee778(%eax)
80106a09:	ff 00 00 
80106a0c:	c7 80 8c 18 11 80 00 	movl   $0xcffa00,-0x7feee774(%eax)
80106a13:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106a16:	c7 80 90 18 11 80 ff 	movl   $0xffff,-0x7feee770(%eax)
80106a1d:	ff 00 00 
80106a20:	c7 80 94 18 11 80 00 	movl   $0xcff200,-0x7feee76c(%eax)
80106a27:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106a2a:	05 70 18 11 80       	add    $0x80111870,%eax
  pd[1] = (uint)p;
...
80106a50:	a1 24 46 11 80       	mov    0x80114624,%eax
...
80106bdb:	68 b1 7b 10 80       	push   $0x80107bb1
...
80106c40:	68 cb 7b 10 80       	push   $0x80107bcb
...
80106cc8:	68 6c 7c 10 80       	push   $0x80107c6c
...
80106d69:	68 e9 7b 10 80       	push   $0x80107be9
...
80106dcb:	68 01 7c 10 80       	push   $0x80107c01
...
80106eac:	68 1d 7c 10 80       	push   $0x80107c1d
...
80106ed3:	bb 80 a4 10 80       	mov    $0x8010a480,%ebx
  memset(pgdir, 0, PGSIZE);
...
80106f0a:	81 fb c0 a4 10 80    	cmp    $0x8010a4c0,%ebx
...
80106f4b:	a3 24 46 11 80       	mov    %eax,0x80114624
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f7c:	68 2e 7c 10 80       	push   $0x80107c2e
...
80106ff2:	68 38 7c 10 80       	push   $0x80107c38
...
801070c7:	68 52 7c 10 80       	push   $0x80107c52
